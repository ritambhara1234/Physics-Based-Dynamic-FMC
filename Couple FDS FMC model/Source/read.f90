...
IF (SIMPLE_CHEMISTRY) THEN
   ...
   SELECT CASE(N_SIMPLE_CHEMISTRY_REACTIONS)
	  ...
	  !print*, 'N_TRACKED_SPECIES', N_TRACKED_SPECIES
   END SELECT
...
21 REWIND(LU_INPUT) ; INPUT_FILE_LINE_NUMBER = 0
   ...
   ENDIF
  ! print*, 'else N_TRACKED_SPECIES', N_TRACKED_SPECIES
ENDIF
...
!print*, 'N_TOTAL_SCALARS', N_TOTAL_SCALARS
