...
INTEGER, PARAMETER :: N_layers = 20;				
REAL(EB) :: q_soil=0._EB;
...
INTEGER, ALLOCATABLE, DIMENSION(:)   :: LU_PART,LU_PROF,LU_XYZ,LU_TERRAIN,LU_PL3D,LU_DEVC,LU_STATE,LU_CTRL,LU_CORE,LU_RESTART, &
				        LU_TEMP, LU_VELO, LU_RTEST, LU_NUMBER, LU_PROFAVG, LU_HPROFAVG   !<Added for profile average
...
INTEGER, ALLOCATABLE, DIMENSION(:,:) :: LU_SLCF,LU_SLCF_GEOM,LU_BNDF,LU_BNDF_GEOM,LU_BNDG,LU_ISOF,LU_ISOF2, &
                                        LU_SMOKE3D,LU_RADF,LU_TEMP_INPUT,LU_WIND_INPUT, &
					LU_MOISTURE, LU_SPEC_HUM, LU_TEMP_A, LU_TEMP_M, LU_LIQ, LU_TEMP_L
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:)   :: FN_PART,FN_PROF,FN_XYZ,FN_TERRAIN,FN_PL3D,FN_DEVC,FN_STATE,FN_CTRL,FN_CORE,FN_RESTART, &
				              FN_TEMP, FN_VELO, FN_RTEST, FN_NUMBER, FN_PROFAVG, FN_HPROFAVG	!<Added for profile average
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_SLCF_GEOM,FN_BNDF,FN_BNDF_GEOM,FN_BNDG, &
                                              FN_ISOF,FN_ISOF2,FN_SMOKE3D,FN_RADF,FN_GEOM_TRNF,FN_TEMP_INPUT,FN_WIND_INPUT, &
				              FN_MOISTURE, FN_SPEC_HUM, FN_TEMP_A, FN_TEMP_M, FN_LIQ, FN_TEMP_L
CHARACTER(9) :: FMT_R
