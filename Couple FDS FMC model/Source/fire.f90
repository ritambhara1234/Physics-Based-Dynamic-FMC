      ...
      ILOOP: DO I=1,IBAR
         ...
         DZZ_IF: IF ( ANY(ABS(DZZ) > TWO_EPSILON_EB) ) THEN
            ...
            DO N=1,N_TRACKED_SPECIES
			   ...
			   !print*, 'before',T,N,I,J,K,TMP(I,J,K),H_S_N, M_DOT_PPP(I,J,K,N)
               M_DOT_PPP(I,J,K,N) = M_DOT_PPP(I,J,K,N) + RHO(I,J,K)*DZZ(N)/DT
			   if (N == 4) then
				M_DOT_PPP(I,J,K,N) = M_DOT_PPP(I,J,K,N) + RHO(I,J,K)*DZZ(N)/DT
			   endif
			   !print*, T,N,I,J,K,TMP(I,J,K),M_DOT_PPP(I,J,K,N),H_S_N
			   !print*, 'after',, RHO(I,J,K), DZZ(N)
            ENDDO
         ENDIF DZZ_IF
      ENDDO ILOOP
   ENDDO   
...
SPEC_LOOP: DO NS = 1, N_TRACKED_SPECIES
   ...
   DO K = 1, KBAR
      DO J = 1, JBAR
         ILOOP: DO I = 1, IBAR
			...
			!print*, 'T_BOIL_EFF', NM, I,J,K, NS, T_BOIL_EFF
   ...
   WALL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
      WC=>WALL(IW)
      IF (WC%BOUNDARY_TYPE /= SOLID_BOUNDARY .OR. WC%ONE_D%NODE_INDEX > 0) CYCLE WALL_LOOP
      ONE_D=>WC%ONE_D
      I = ONE_D%IIG
      J = ONE_D%JJG
      K = ONE_D%KKG
