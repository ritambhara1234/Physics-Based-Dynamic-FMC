...
ALLOCATE(M%AVG_T(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_T',IZERO)
ALLOCATE(M%AVG_U(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_U',IZERO)
ALLOCATE(M%AVG_V(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_V',IZERO)
ALLOCATE(M%AVG_W(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_W',IZERO)
ALLOCATE(M%AVG_TW(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_TW',IZERO)
ALLOCATE(M%AVG_TU(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_TU',IZERO)
ALLOCATE(M%AVG_TV(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_TV',IZERO)
ALLOCATE(M%AVG_UV(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_UV',IZERO)
ALLOCATE(M%AVG_WV(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_WV',IZERO)
ALLOCATE(M%AVG_WU(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_WU',IZERO)
ALLOCATE(M%AVG_U2(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_U2',IZERO)
ALLOCATE(M%AVG_V2(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_V2',IZERO)
ALLOCATE(M%AVG_W2(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_W2',IZERO)
ALLOCATE(M%AVG_T2(0:IBP1,0:JBP1,0:KBP1),STAT=IZERO)
CALL ChkMemErr('INIT','AVG_T2',IZERO)
...
!! Variables Defined For Moisture Model Data
INP_N_LAYERS = N_LAYERS
ALLOCATE(M%koba_m_fin(1:data_tot,1:INP_N_LAYERS),STAT=IZERO)
CALL ChkMemErr('INIT','koba_m_fin',IZERO)
ALLOCATE(M%koba_q_fin(1:data_tot,1:INP_N_LAYERS),STAT=IZERO)
CALL ChkMemErr('INIT','koba_q_fin',IZERO)
ALLOCATE(M%koba_ta_fin(1:data_tot,1:INP_N_LAYERS),STAT=IZERO)
CALL ChkMemErr('INIT','koba_ta_fin',IZERO)
ALLOCATE(M%koba_tm_fin(1:data_tot,1:INP_N_LAYERS),STAT=IZERO)
CALL ChkMemErr('INIT','koba_tm_fin',IZERO)
ALLOCATE(M%koba_l_fin(1:data_tot,1:INP_N_LAYERS),STAT=IZERO)
CALL ChkMemErr('INIT','koba_l_fin',IZERO)
ALLOCATE(M%koba_tl_fin(1:data_tot,1:INP_N_LAYERS),STAT=IZERO)
CALL ChkMemErr('INIT','koba_tl_fin',IZERO)
ALLOCATE(M%koba_soiltemp(1:data_tot,1:20),STAT=IZERO)
CALL ChkMemErr('INIT','koba_soiltemp',IZERO)
...
M%koba_l_fin=0._EB
M%koba_tl_fin=0._EB
M%koba_soiltemp=0._EB

ALLOCATE(M%store_q_g_ppp(1:data_tot,1:5),STAT=IZERO)
CALL ChkMemErr('INIT','store_q_g_ppp',IZERO)

M%store_q_g_ppp=0._EB
...
!      ALLOCATE(M%TEMP_SURF(1:data_tot,1),STAT=IZERO)
!   CALL ChkMemErr('INIT','TEMP_SURF',IZERO)
!   M%TEMP_SURF=10._EB
ENDIF
...
DO IW=1,M%N_EXTERNAL_WALL_CELLS
   K = M%WALL(IW)%ONE_D%KKG
   M%U_GHOST(IW) = M%U_WIND(K)
   M%V_GHOST(IW) = M%V_WIND(K)
   M%W_GHOST(IW) = M%W_WIND(K)
ENDDO
      ...
      DO ICF=1,M%N_CUTFACE_MESH
         ...
         IF (CFA%NVEC(KAXIS)>-TWO_EPSILON_EB .AND.  CFA%BOUNDARY_TYPE==SOLID_BOUNDARY) THEN
            IF (CFA%ONE_D%KKG > M%K_AGL_SLICE(CFA%ONE_D%IIG,CFA%ONE_D%JJG,NSLICE)) THEN
               M%K_AGL_SLICE(CFA%ONE_D%IIG,CFA%ONE_D%JJG,NSLICE) = &
                  MIN( M%KBAR , M%K_AGL_SLICE(CFA%ONE_D%IIG,CFA%ONE_D%JJG,NSLICE)+CFA%ONE_D%KKG )
            ENDIF
         ENDIF
      ENDDO
   ENDDO
...
ALLOCATE(SMOKE3D_CLOCK(NMESHES),STAT=IZERO)
CALL ChkMemErr('INIT','SMOKE3D_CLOCK',IZERO)
...
IF (.NOT.MASS_FILE) MASS_CLOCK = 1.E10_EB
