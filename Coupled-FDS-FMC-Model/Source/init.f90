...
ALLOCATE(M%koba_m_fin(1:data_tot,1:5),STAT=IZERO)
CALL ChkMemErr('INIT','koba_m_fin',IZERO)
ALLOCATE(M%koba_q_fin(1:data_tot,1:5),STAT=IZERO)
CALL ChkMemErr('INIT','koba_q_fin',IZERO)
ALLOCATE(M%koba_ta_fin(1:data_tot,1:5),STAT=IZERO)
CALL ChkMemErr('INIT','koba_ta_fin',IZERO)
ALLOCATE(M%koba_tm_fin(1:data_tot,1:5),STAT=IZERO)
CALL ChkMemErr('INIT','koba_tm_fin',IZERO)
ALLOCATE(M%koba_l_fin(1:data_tot,1:5),STAT=IZERO)
CALL ChkMemErr('INIT','koba_l_fin',IZERO)
ALLOCATE(M%koba_tl_fin(1:data_tot,1:5),STAT=IZERO)
