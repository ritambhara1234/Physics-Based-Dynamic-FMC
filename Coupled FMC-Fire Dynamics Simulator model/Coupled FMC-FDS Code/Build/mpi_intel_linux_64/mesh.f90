...
! Variables defined for profile average code and moisture model
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: AVG_T, AVG_U, AVG_V, AVG_W, AVG_TW, AVG_TU, AVG_TV, &
									AVG_UV, AVG_WV, AVG_WU, AVG_U2, AVG_V2, AVG_W2, AVG_T2
									
   REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: koba_m_fin, koba_q_fin, koba_ta_fin, koba_tm_fin, &
									koba_l_fin, koba_tl_fin, store_q_g_ppp, koba_soiltemp  	! Surface temperature for moisture model
!, TEMP_SURF
   ...
   ! REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: AVG_T, AVG_U, AVG_V, AVG_W	! <Added for profile average
   ...
   INTEGER,ALLOCATABLE,DIMENSION(:) :: count_start, count_end 	!< Time for profile average
   REAL(EB),ALLOCATABLE,DIMENSION(:) :: P_TIME_START, P_TIME_END 	!< Time for profile average
...
!REAL(EB), POINTER, DIMENSION(:,:,:) :: AVG_T, AVG_U, AVG_V, AVG_W	!<Added for profile average
...
REAL(EB), POINTER, DIMENSION(:) :: P_TIME_START, P_TIME_END		!< Profile Averaged Time
INTEGER, POINTER, DIMENSION(:) :: count_start, count_end		!< Profile Averaged Time

REAL(EB), POINTER, DIMENSION(:,:,:) :: AVG_T, AVG_U, AVG_V, AVG_W, AVG_TW, AVG_TU, AVG_TV, &
									AVG_UV, AVG_WV, AVG_WU, AVG_U2, AVG_V2, AVG_W2, AVG_T2		!Profile Averaged Data
									
REAL(EB), POINTER, DIMENSION(:,:) :: koba_m_fin, koba_q_fin, koba_ta_fin, koba_tm_fin, &
									koba_l_fin, koba_tl_fin, koba_soiltemp						!Fuel Moisture Model
!,TEMP_SURF
...
!! Fuel Moisture Model
koba_m_fin=>M%koba_m_fin
koba_q_fin=>M%koba_q_fin
koba_ta_fin=>M%koba_ta_fin
koba_tm_fin=>M%koba_tm_fin
koba_l_fin=>M%koba_l_fin
koba_tl_fin=>M%koba_tl_fin
koba_soiltemp=>M%koba_soiltemp
!! Fuel Moisture Model
...
!! Surface temperature for moisture model
!TEMP_SURF=>M%TEMP_SURF
...
! AVG_V=>M%AVG_V
! AVG_W=>M%AVG_W
P_TIME_START=>M%P_TIME_START
P_TIME_END=>M%P_TIME_END
count_start=>M%count_start
count_end=>M%count_end
