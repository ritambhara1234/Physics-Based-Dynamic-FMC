...
REAL(EB), DIMENSION(144000,1) :: DNI_input, RelH_input
...
! REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: AVG_TW_PRIME, AVG_TU_PRIME, AVG_TV_PRIME, AVG_UV_PRIME, &
									! AVG_WV_PRIME, AVG_WU_PRIME, AVG_U2_PRIME, AVG_V2_PRIME, AVG_W2_PRIME, AVG_T2_PRIME
! REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: HAVG_TW_BAR, HAVG_TU_BAR, HAVG_TV_BAR, &
									! HAVG_UV_BAR, HAVG_WV_BAR, HAVG_WU_BAR, &
									! HAVG_U2_BAR, HAVG_V2_BAR, HAVG_W2_BAR, HAVG_T2_BAR
! REAL(EB), ALLOCATABLE, DIMENSION(:,:) :: HAVG_TW_PRIME, HAVG_TU_PRIME, HAVG_TV_PRIME, &
									! HAVG_UV_PRIME, HAVG_WV_PRIME, HAVG_WU_PRIME, &
									! HAVG_U2_PRIME, HAVG_V2_PRIME, HAVG_W2_PRIME, HAVG_T2_PRIME
!REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: TEMP_R, U_VEL_R, V_VEL_R, W_VEL_R
